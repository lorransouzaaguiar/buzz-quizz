    ...
    const formBasicQuizz = () => {
        ...
        botao.onclick = async () => {
            ...
            if (respostaValidas) {
                ...
                const quizzQuastionPage = QuizzQuestionPage(dados.numeroPerguntas, dados)
                renderBody(quizzQuastionPage.render())
                quizzQuastionPage.formQuestionQuizz()
            } else {
...
export function validarDadosQuizz(todosInputsValidos) {
